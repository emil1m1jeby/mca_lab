...
/*$table_qry="CREATE TABLE product1(id INT PRIMARY KEY AUTO_INCREMENT,
...
<?php
	...
	$n3=$_POST['n3'];
	$n4=$_POST['n4'];
	$insert_qry="INSERT INTO product1(productname,producttype,dimension,price) VALUES ('$n1','$n2','$n3','$n4')";
